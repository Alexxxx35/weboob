...
class FakebankModule(Module, CapBank):
    ...
    CONFIG = BackendConfig(Value('username', label='Username', regexp='.+'),#any caracter as many times as it appears
    ...
    # def iter_accounts(self, id):
    #     accounts = list(self.iter_accounts())
    #     if len(accounts) > accounts[int(id)]:
